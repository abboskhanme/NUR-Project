...
class Settings(BaseSettings):
    ...
    # Hujjat imzolari — kafolat sertifikatiga avtomatik qo'yiladigan imzo
    # rasmlari. Rasmlar `DOC_ASSETS_DIR` papkasidan olinadi (bo'sh bo'lsa
    # `app/assets/docs`), fayl nomlari: imzo-savdo.png, imzo-servis.png.
    # Fayl topilmasa — o'rniga bo'sh imzo chizig'i chiziladi.
    DOC_ASSETS_DIR: str = ""
