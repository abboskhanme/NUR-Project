...
class SalesSummary(BaseModel):
    ...
    # Oldingi davr (o'tgan oy/yil) ko'rsatkichlari — qiyoslash uchun.
    # None = qiyoslash davri berilmagan (masalan qidiruvда).
    orders_prev: Optional[int] = None
    delivered_prev: Optional[int] = None
