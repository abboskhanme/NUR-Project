...
export default function ReceiptModal({
  ...
  vendors: VendorLite[];
  fixedVendorId?: string;   // taminotchi rejimida vendor avtomatik
  onClose: () => void;
  onSaved: () => void;
}) {
  ...
  // Mahsulot tanlanganda belgilangan narxni avtomatik qo'yamiz (foydalanuvchi o'zgartirmagan bo'lsa)
  useEffect(() => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={onClose}>
      <div className="bg-card rounded-lg shadow-xl w-full max-w-md flex flex-col"
        ...
        <div className="p-5 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="label">Miqdor *{selected ? ` (${selected.unit})` : ''}</label>
